...
# For dimension table passengers
...
# Combined view of bookings, flights, passengers, and airports.  
...
def silver_business():
    # Reading the curated Silver tables as streams
    df = (dlt.read_stream('silver_bookings')\
        # Joining them together on their shared keys (flight_id, passenger_id, airport_id).
        ...
        .drop('modifiedDate'))      # Since all tables have this column it creates ambiguity for joins and throw error
    return df
